...
output_path=${local_root}/30layerESM_3EGNN_1e8
rm -rf ${output_path}
mkdir ${output_path}
...
--criterion protein_complex_loss --seq-factor 1.0 --coor-factor 0.001 \
--arch protein_protein_complex_model_esm \
...
--lr 5e-8 --lr-scheduler inverse_sqrt \
--stop-min-lr '1e-15' --warmup-updates 4000 \
--warmup-init-lr '1e-8' \
--clip-norm 0.0001 \
